...
The Marker in addition to detailing the consecration also celebrates the 9.0.0.0.0 b'aktun ending on 8 Ajaw 14 Kej, or December 9, 435 (Fash 2011, 105; Fash, Fash, and Davis-Salazar, 76). This auspicious event would continue to be represented in Copan monuments through the end of the dynasty.
...
The nature of the censers comments on the relation of fire to the royal line in two ways. Succession could be visualized as passing down the k'awiil scepter, or the torch in God K's head, from king to king. <a href="{{site.baseurl}}/altar-q">Altar Q</a> not only depicts this handing off of the scepter, but also explains how <a href="{{site.baseurl}}/yax-kuk-mo">Yax K'uk' Mo'</a> first received the scepter. The censers as receptacles of fire reflects this passing of the k'awiil. These censers would have also served the purpose of providing breath to the ancestors, calling them back (Taube 2004, 268).
